...
--  implement move-to-tag
--  open Firefox in tabbed layout on tag 2
--  open Thunderbird in tabbed layout on tag 3
--  Rofi
...
local hotkeys_popup_jo_sized = hotkeys_popup_jo.widget.new({ width = 960, height = 450 });
...
beautiful.init(gears.filesystem.get_themes_dir() .. "zenburn/theme.lua")
  -- zenburn  gets  cbatticon  &  MicTray  icon visible
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "Escape",
        ...
        {description = "toggle between last two clients", group = "client"}),
    ...
    awful.key({ modkey, "Shift" }, "i",
              ...
              {description = "restore minimized client (in order)", group = "client"}),
...
awful.rules.rules = {
    ...
    -- { rule = { class = {"Gvim"}, properties = {floating = true} },
...
local function set_wallpaper(s)
    ...
    -- end
    gears.wallpaper.set("#000000") -- black...
end
