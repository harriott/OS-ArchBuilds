...
# cp $OSAB/etc/systemd/rsnapshot/minuteTest.timer /etc/systemd/system/rsnapshot-minuteTest.timer
...
# cp $OSAB/etc/systemd/rsnapshot/hourlySF.timer /etc/systemd/system/rsnapshot-hourly.timer
# cp $OSAB/etc/systemd/rsnapshot/hourlySF.service /etc/systemd/system/rsnapshot-hourly.service
