...
#=> 1 Emacs safely
ln -sf $ARCHBUILDS/jo/ES/locks.sh ~/Arch/Elocks.sh
sudo ln -sf $ARCHBUILDS/jo/ES/emacs_safely.sh /usr/local/bin/emacs_safely
sudo ln -sf $ARCHBUILDS/jo/ES/emacs_safely.desktop /usr/share/applications/emacs_safely.desktop
