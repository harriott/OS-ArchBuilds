...
for aif in all-the-icons file-icons fontawesome material-design-icons octicons weathericons; do
  sudo ln -sf $cITcc/CP/Emacs-domtronn-all-the-icons.el/fonts/$aif.ttf /usr/share/fonts/EmacsAllTheIcons/$aif.ttf
  # $misc/GRs/needed.sh
done
eza -la /usr/share/fonts/EmacsAllTheIcons

#=> 1 fonts 0 install
lnd $cITcc/unix-linux-forArch-fonts /usr/share/fonts/copiedForArch
