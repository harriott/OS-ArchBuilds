...
# time (sudo find $rsnapshot/aaa.0/localhost | wc -l)  took 8m to report  1739787
...
# time (sudo find $rsnapshot/aaa.1/localhost | wc -l)  took 8m to report  2063013
...
# time (sudo find $rsnapshot/aaa.2/localhost | wc -l)  took 8m to report  2063013
