...
# JH
# nvim -O /usr/share/clifm/plugins/img_viewer.sh $ARCHBUILDS/jo/CliFM/img_viewer.sh -c 'windo difft'
# see  img_viewer  in  $bs/anytime/symlinks-jo-0.sh
...
if type feh > /dev/null 2>&1; then
	feh -tZ --index-info '' -W 1360 -- "$args" && exit 0 || found=1  # JH
