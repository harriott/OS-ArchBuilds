...
# cp $OSAB/extra-etc/systemd/rsnapshot/hourly.timer /etc/systemd/system/rsnapshot-hourly.timer
# cp $OSAB/extra-etc/systemd/rsnapshot/daily.timer /etc/systemd/system/rsnapshot-daily.timer
# cp $OSAB/extra-etc/systemd/rsnapshot/weekly.timer /etc/systemd/system/rsnapshot-weekly.timer
# cp $OSAB/extra-etc/systemd/rsnapshot/monthly.timer /etc/systemd/system/rsnapshot-monthly.timer
# cp $OSAB/extra-etc/systemd/rsnapshot/ampersand.service /etc/systemd/system/rsnapshot@.service
# cp $OSAB/extra-etc/systemd/rsnapshotMinute/test.timer /etc/systemd/system/rsnapshot-test.timer
