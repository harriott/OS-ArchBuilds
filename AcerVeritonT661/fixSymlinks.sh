...
# ln -s $DROPBOX/$ARCHBUILDS/jo/bashrc-console ~/bashrc-console
...
# rm -r ~/.urxvt/ext; ln -s $DROPBOX/$ARCHBUILDS/jo/urxvt/Perls ~/.urxvt/ext

# recovering Openbox from Console
