...
#=> DokuWiki 1 conf/
cp $coreIT/DokuWiki/userstyle.css /usr/share/webapps/dokuwiki/conf/userstyle.css
cp $coreIT/DokuWiki/stopwords/non_technical_words.txt /usr/share/webapps/dokuwiki/conf/stopwords.txt
